      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DrawerListTile(icon: Icons.cabin, onTap: () => drawerProvider.goToProfile(context), title: S.of(context).profile),
            DrawerListTile(icon: Icons.car_crash, onTap: () => drawerProvider.goToVehiclesCustomer(context), title: S.of(context).myVehicles),
            DrawerListTile(icon: Icons.wallet_outlined, onTap: () => drawerProvider.goToWalletCustomer(context), title: S.of(context).wallet),
